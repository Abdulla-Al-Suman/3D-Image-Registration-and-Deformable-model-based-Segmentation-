% used for different threshold for different muscles
...
clear all 
close all
load('TMD-m11sLf12.mat')
X11 = xnnnnn; % X11=11 no muscle
Y11= ynnnnn; 
load('TMD-m16sLf12.mat')
X16 = xnnnnn; % X11=11 no muscle
Y16= ynnnnn; 


load('TMD-m3sRf16.mat')  % contains xnnnn, ynnnn,xnnnnn,ynnnnn
load('P1.mat')
...
%     XX(i,2) = Y(i);
% end
sigma=9;TGM =9;TGM2 = 18000; Dmax = 26;
win = 1000; % internal force waiting
wex = 500;wd = 17.8; %im=20;%wdamp=1.6;
%TSDmax = 0;
