...
load('TMD-m22sRf8.mat')  % contains xnnnn, ynnnn,xnnnnn,ynnnnn
load('P1.mat')
    ...
    isd;
        ...
        for i=1:10 % deformation iteration
            ...
            %         
                    ...
                    c1 = ud1-udn; un1 = c1/(norm(c1)); % un1=unit normal
