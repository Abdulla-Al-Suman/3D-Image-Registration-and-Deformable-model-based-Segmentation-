...
MSRO = 15; %MSRO= Maximum Search remove overlap
...
P1 = [X(overlapj),Y(overlapj)];  % position vectors
                                      ...
                                      %Stheta
                                            ...
                                            if (Stheta>=355 && Stheta<360) || (Stheta>=0 && Stheta<5)% along curvature or normal search start
                                                    for io= 1:MSRO
