...
%x2=VV;
[M,N,O] = size(x1);
MN = 3; SN = 1; FN = 20; % MN=muscle number, SN= side number, FN= frame number

xl1 = muscle_data{MN}{SN}{FN}.x;  % muscle selection
yl1 = muscle_data{MN}{SN}{FN}.y;
...
save TMD-test2 xnnnnn ynnnnn SNIRI

figure
imagesc([VV(:,:,SNIRI) V(:,:,SNIRI)]), colormap(gray(256));
hold on
plot(xnnnnn,ynnnnn,'g',xnnnnn+256,ynnnnn,'r')
